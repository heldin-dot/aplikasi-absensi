...
class User extends MY_Controller {
    ...
    function __construct() {
        ...
        $this->fields = array(
            "name" => array("TIPE" => "STRING", "LABEL" => "Nama"),
            "nama_branch" => array("TIPE" => "STRING", "LABEL" => "Nama"),
            "username" => array("TIPE" => "STRING", "LABEL" => "Username"),
            "group_name" => array("TIPE" => "STRING", "LABEL" => "User Group"),            
...
//        }
    ...
    public function dataInput() {
        ...
        if((!$this->input->post('photo') || $this->input->post('photo')) && $this->input->post('password')){
            $this->form_validation->set_rules('password', 'Password', 'trim|required|min_length[7]|max_length[255]');
...
//            $this->form_validation->set_rules('password', 'Password', 'trim|required|min_length[7]|max_length[255]');
            $this->form_validation->set_rules('id_group', 'Menu Group', 'required');
